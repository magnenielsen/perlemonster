...
async function imageBase64ToGrid(
  ...
  // rd-plus generates native pixel art that fills the frame — scale directly,
  // disable smoothing so pixel edges stay sharp rather than blurring together
  const out = document.createElement('canvas')
  out.width = cols * 16; out.height = rows * 16

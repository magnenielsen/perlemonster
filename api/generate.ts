...
const SUBJECT_PROMPTS: Record<string, string> = {
  ...
  mai17:   'chibi Norwegian Constitution Day character — a cheerful child in a colorful bunad folk costume, big round head, huge sparkling eyes, rosy cheeks, thick bold smile, red white and blue Norwegian colors',
}
